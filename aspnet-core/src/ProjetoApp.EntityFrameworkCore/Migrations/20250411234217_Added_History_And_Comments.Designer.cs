...
{
    [DbContext(typeof(ProjetoAppDbContext))]
    [Migration("20250411234217_Added_History_And_Comments")]
    partial class Added_History_And_Comments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjetoApp.Domain.Project", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("ProjetoApp.Domain.ProjectTask", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProjetoApp.Domain.TaskComment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProjetoApp.Domain.TaskHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProjetoApp.Domain.ProjectTask", b =>
                {
                    b.HasOne("ProjetoApp.Domain.Project", "Project")
                        .WithMany("Tasks")
            ...
            modelBuilder.Entity("ProjetoApp.Domain.TaskComment", b =>
                {
                    b.HasOne("ProjetoApp.Domain.ProjectTask", "Task")
                        .WithMany()
